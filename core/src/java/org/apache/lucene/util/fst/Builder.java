...
public class Builder<T> {
  ...
  // in build performance on 9.8M Wikipedia terms; so we left this as an array:
  // current "frontier"
   ...
   */
	public Builder(FST.INPUT_TYPE inputType, int minSuffixCount1, int minSuffixCount2, boolean doShareSuffix,
			...
			boolean doPackFST, float acceptableOverheadRatio, boolean allowArrayArcs, int bytesPageBits) {

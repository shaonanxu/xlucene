...
public abstract class AtomicReader extends IndexReader {
  ...
  /** 
   *  Returns {@link NumericDocValues} for this field, or null if no {@link NumericDocValues} were indexed for
   *  this field.  The returned instance should only be used by a single thread. 
   */
  public abstract NumericDocValues getNumericDocValues(String field) throws IOException;

  /** 
   *  Returns {@link BinaryDocValues} for this field, or null if no {@link BinaryDocValues} were indexed for
   *  this field.  The returned instance should only be used by a single thread. 
   */
   ...
   *  there are no deleted documents (all documents are live).
   *
   *  The returned instance has been safely published for
   *  use by multiple threads without additional synchronization.
   */
